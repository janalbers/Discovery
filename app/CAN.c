...
//Enable reception of messages to ID MY_CAN_IDENTIFIER !!!!!
  CAN_wrFilter (1, identifier, EXTENDED_FORMAT);          /* Enable reception of msgs */
...
{
    CAN_TxMsg[1].id = identifier;
    CAN_TxMsg[1].format = EXTENDED_FORMAT;
    CAN_TxMsg[1].type = DATA_FRAME;/* initialize msg to send   */
}
